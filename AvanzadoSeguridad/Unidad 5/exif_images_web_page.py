...
def printMetadata(): # Con esta funcion extraemos los metadatos de las imagenes que se hayan descargado.
...
def main(): # Método principal que obtiene una url como argumento de entrada y llama a los métodos.
